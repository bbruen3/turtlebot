...
def main():
    ...
    print("X by 1")
    move(dist_x=1, dist_y=0, isForward=True, speed=1)
    rotate(90, False)
    print("Y by 6.8")
    move(dist_x=6.8, dist_y=0, isForward=True, speed=1)
    rotate(90, True)
    print("X by 1")
    move(dist_x=1, dist_y=0, isForward=True, speed=1)
    rotate(90, False)
    ...
    rotate(90, False)
    print("Y by 13.6")
    move(dist_x=13.6, dist_y=0, isForward=True, speed=1)
    rotate(90, True)
    print("X by 1")
    move(dist_x=1, dist_y=0, isForward=True, speed=1)
    rotate(90, False)
    print("Y by 27.2")
    move(dist_x=27.2, dist_y=0, isForward=True, speed=1)
    rotate(90, True)
    print("X by 2")
    move(dist_x=2, dist_y=0, isForward=True, speed=1)
